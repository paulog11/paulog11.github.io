    ...
    <div class="space-y-3">
      ...
      <div class="relative">
        <input
          ...
          class="w-full px-3 py-2 pl-9 text-sm rounded-md border border-koshi bg-surface/80 placeholder:text-usuzumi/50 focus:outline-none focus:ring-2 focus:ring-ai/30 focus:border-ai/50"
