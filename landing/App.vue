<template>
  <div class="h-full flex flex-col bg-parchment font-body overflow-hidden">
    ...
    <!-- ── Main ── -->
    <main class="flex-1 flex flex-col items-center justify-center px-6 overflow-hidden">
...
const portfolioUrl = ref('https://yourusername.github.io/portfolio')
...
const apps = ref([
  ...
  //   tags: ['Category'],
  //   icon: '✦',
  //   url: 'https://link-to-live-app.com',
  //   comingSoon: false,
  // },
])
